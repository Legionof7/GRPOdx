# Direct imports from Verdict - no fallbacks or complex installation logic
...
def evaluate_diagnosis(response: str, disease_info: Dict, verbose: bool = False) -> float:
    ...
    if verbose:
        print("Evaluating with Verdict...")
    
    # Run the evaluation directly
    verdict_response, _ = evaluator.run(input_data, max_workers=1)
    
    # Extract the score
    score = verdict_response['DiagnosisEvaluator_root.block.unit_score']
